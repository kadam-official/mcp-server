...
describe("parseImageDimensions", () => {
  it("parses PNG dimensions from IHDR chunk", () => {
    ...
    buf[0] = 0x89; buf[1] = 0x50; // PNG magic
    // Width = 300 (0x0000012C) at offset 16
    buf[16] = 0x00; buf[17] = 0x00; buf[18] = 0x01; buf[19] = 0x2C;
    // Height = 250 (0x000000FA) at offset 20
    buf[20] = 0x00; buf[21] = 0x00; buf[22] = 0x00; buf[23] = 0xFA;
  ...
  it("parses JPEG dimensions from SOF0 marker", () => {
    ...
    buf[7] = 0x01; buf[8] = 0xE0;
    // Width = 640 (0x0280) at offset 9
    buf[9] = 0x02; buf[10] = 0x80;
  ...
  it("parses JPEG with SOF2 (progressive) marker", () => {
    ...
    buf[2] = 0xFF; buf[3] = 0xC2; // SOF2 (progressive)
    buf[4] = 0x00; buf[5] = 0x11;
    buf[6] = 0x08;
    buf[7] = 0x00; buf[8] = 0xC8; // height = 200
    buf[9] = 0x01; buf[10] = 0x90; // width = 400
